...
// Todas las sentencia llevan ; (punto y coma) al final
   ...
   */ 
   ...
   /*
   print ( "<a href = 'http://www.mclibre.org/consultar/php/'>http://www.mclibre.org/consultar/php/</a> <br>");
...
echo ("<br/>");
//expresiones
print ( "<a href = 'http://php.net/manual/es/language.expressions.php'>AYUDA expresiones en php</a> <br>");
echo ("<br/>");
echo ("<hr><br/>");
...
const MIN_VALUE = 1.2;        // Una forma de definir Y DAR VALOR
define("DIAS_SEMANA",7);      // Otra forma de definir Y DAR VALOR
...
print("variable 'var1' CONTIENE => $var1 || TIPO =>".gettype($var1)." <br/>");
echo ("<br/>");
