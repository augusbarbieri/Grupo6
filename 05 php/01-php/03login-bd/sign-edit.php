    ...
    <div class="container">
      ...
      <form class="form-horizontal" action="sign-update.php" method="post">       
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input disabled  type="email" class="form-control" name="email" id="inputEmail3" placeholder="Email" required value=<?php echo $email;?>>
          </div>
        </div>
        <div class="form-group">
            <label for="inputApellido" class="col-sm-2 control-label">Apellido</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="apellido" id="inputApellido" placeholder="Apellido" required value=<?php echo $apellido;?>>
            </div>
        </div>
        <div class="form-group">
            <label for="inputNombre" class="col-sm-2 control-label">Nombre</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="nombre" id="inputNombre" placeholder="Nombre" required value=<?php echo $nombre;?> >
            </div>
        </div>
        ...
        <div class="form-group">
          <div class="col-sm-offset-2 col-sm-10">
            <button <?php $estadoBotonEnviar ?> type="submit" onclick="return confirm('Confirma actualizar los datos ?');" class="btn btn-default">Enviar</button>
