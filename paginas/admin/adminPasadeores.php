...
<head>
    ...
    <title> Manadas - Paseadores</title>
  ...
  <div class="mb-4 w-100">
    ...
    <div class="ms-3 me-3 mt-5">
        <div class="d-flex align-items-center mb-4">
            ...
            <button type="button" class="btn btn-primary ms-auto" onclick="location.href='adminFormAddPaseador.html'">Agregar Paseador</button>
        </div>
