    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navPaseador">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item">
            <a class="nav-link fw-bold active" aria-current="page" href="misPaseosPaseador.html">Mis Paseos</a>
          </li>
          <li class="nav-item">
            <a class="nav-link fw-bold" href="perfilPaseador.html">Mi Perfil</a>
          </li>
        </ul>
      </div>
    </div>
