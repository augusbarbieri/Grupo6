...
<section class="hero text-center p-5">
    ...
    <button class="btn btn-warning btn-lg mt-3" onclick="window.location.href='<?php echo BASE_URL; ?>paginas/registro.php'">
        Registrarme
    </button>
</section>
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="walker-carousel flex-grow-1 mx-3" id="walkerCarousel">
            <div class="walker-card">
                <img src="<?php echo BASE_URL; ?>Assets/img/walker1.jpg" alt="Walker 1">
                <h5>Kavu</h5>
                <p>Amante de los perros chicos. 4.9 ★</p>
                <button class="btn btn-warning btn-lg mt-3" onclick="window.location.href='<?php echo BASE_URL; ?>paginas/dueno/FormPaseador.php'">Pasear</button>
            </div>
            <div class="walker-card">
                <img src="<?php echo BASE_URL; ?>Assets/img/walker2.jpg" alt="Walker 2">
                <h5>Carlos</h5>
                <p>Experto en paseos largos. 5.0 ★</p>
                <button class="btn btn-warning btn-lg mt-3" onclick="window.location.href='<?php echo BASE_URL; ?>paginas/dueno/FormPaseador.php'">Pasear</button>
            </div>
            <div class="walker-card">
                <img src="<?php echo BASE_URL; ?>Assets/img/walker3.jpg" alt="Walker 3">
                <h5>Ana</h5>
